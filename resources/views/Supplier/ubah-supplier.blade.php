                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('update-supplier', $sup->id) }}" method="post">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            <textarea name="alamat" id="alamat" class="form-control" placeholder="Alamat">{{ $sup->alamat }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <input name="kota" id="kota" class="form-control" placeholder="Kota"
                                                value="{{ $sup->kota }}"></input>
                                        </div>
                                        <div class="form-group">
                                            <input name="nomor_telepon" id="nomor_telepon" class="form-control"
                                                placeholder="Nomor Telepon" value="{{ $sup->nomor_telepon }}"></input>
                                        </div>
                                        <div class="form-group">
